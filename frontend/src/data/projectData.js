...
//           type: "folder", 
//           children: [
//             { name: "CNN 아키텍처.md", type: "file" },
//             { name: "RNN 구현.py", type: "file" },
//             { name: "Transformer 모델.ipynb", type: "file" }
//           ] 
//         },
//         { 
//           name: "데이터셋", 
//           type: "folder", 
//           children: [
//             { name: "MNIST.csv", type: "file" },
//             { name: "CIFAR-10.zip", type: "file" }
//           ] 
//         },
//         { 
//           name: "실험 결과", 
//           type: "folder", 
//           children: [
//             { name: "실험1-정확도.xlsx", type: "file" },
//             { name: "모델 성능 비교.pdf", type: "file" }
//           ] 
//         }
//       ],
//       chat: {
//         title: "딥러닝 모델 설명",
//         content: "딥러닝은 인공 신경망을 여러 계층으로 구성하여 복잡한 패턴을 학습하는 기계학습의 하위 분야입니다. 주요 딥러닝 모델은 다음과 같습니다:\n\n1. CNN (Convolutional Neural Network): 이미지 처리에 주로 사용되며, 필터를 통해 특징을 추출하는 합성곱 층과 특징의 위치 불변성을 제공하는 풀링 층으로 구성됩니다.\n\n2. RNN (Recurrent Neural Network): 시퀀스 데이터 처리에 적합하며, 이전 단계의 정보를 기억하고 다음 단계에 전달하는 순환 구조를 가집니다.\n\n3. Transformer: 자기 주의 메커니즘(self-attention)을 사용하여 시퀀스 데이터를 처리하며, 병렬 처리가 가능하고 장거리 의존성을 효과적으로 학습할 수 있습니다."
//       },
//       memo: {
//         title: "AI 연구 노트",
//         content: "# 강화학습 알고리즘 비교\n\n## Q-Learning\n- 모델 프리(Model-free) 알고리즘\n- 간단하지만 이산 상태 공간에만 효율적\n\n## Policy Gradient\n- 직접 정책 최적화\n- 연속 행동 공간에 적합\n\n## 성능 비교 코드\n```python\nimport numpy as np\nimport matplotlib.pyplot as plt\n\ndef compare_algorithms(env, algorithms, episodes=1000):\n    results = {}\n    for alg in algorithms:\n        results[alg.name] = alg.train(env, episodes)\n    return results\n```\n\n다음 주 연구 미팅에서 결과 공유 예정"
//       },
//       nodes: [
//         { id: "main", label: "AI", type: "main", x: 50, y: 50 },
//         { id: "data", label: "Data", type: "sub", x: 30, y: 20 },
//         { id: "model", label: "Model", type: "sub", x: 70, y: 30 },
//         { id: "eval", label: "Eval", type: "sub", x: 60, y: 70 },
//         { id: "b1", label: "D", type: "small", x: 40, y: 35 },
//         { id: "b2", label: "M", type: "small", x: 65, y: 45 }
//       ]
//     },
//     {
//       id: 3,
...
//           type: "folder", 
//           children: [
//             { name: "API 명세서.md", type: "file" },
//             { name: "개발 가이드.pdf", type: "file" }
//           ] 
//         }
//       ],
//       chat: {
//         title: "React vs Vue 비교",
//         content: "React와 Vue는 모두 인기 있는 프론트엔드 JavaScript 프레임워크로, 각각 다음과 같은 특징이 있습니다:\n\n1. React:\n   - Facebook에서 개발 및 유지 관리\n   - JSX를 사용하여 JavaScript 내에서 UI 컴포넌트 정의\n   - 단방향 데이터 흐름으로 예측 가능한 상태 관리\n   - 큰 생태계와 풍부한 라이브러리\n\n2. Vue:\n   - Evan You가 개발한 프로그레시브 프레임워크\n   - HTML 템플릿과 JavaScript 로직 분리 가능\n   - 양방향 바인딩 지원으로 간편한 폼 처리\n   - 비교적 완만한 학습 곡선\n\n두 프레임워크 모두 가상 DOM을 사용하며 컴포넌트 기반 아키텍처를 가지고 있습니다. 프로젝트 요구사항과 팀의 경험에 따라 선택하는 것이 좋습니다."
//       },
//       memo: {
//         title: "웹 프로젝트 계획",
//         content: "# 웹 애플리케이션 개발 일정\n\n## 1주차: 환경 설정\n- React + TypeScript 프로젝트 생성\n- 필요한 라이브러리 설치\n- CI/CD 파이프라인 구성\n\n## 2주차: 기본 기능 구현\n- 사용자 인증 (로그인/회원가입)\n- 대시보드 레이아웃\n- API 연동\n\n## 코드 스타일 가이드\n```typescript\n// 컴포넌트 예시\nfunction Button({ text, onClick }: ButtonProps): JSX.Element {\n  return (\n    <button className=\"btn btn-primary\" onClick={onClick}>\n      {text}\n    </button>\n  );\n}\n```\n\n## 디자인 시스템\n- 색상: #3366FF (주요), #FF6633 (강조)\n- 폰트: 'Pretendard', sans-serif"
//       },
//       nodes: [
//         { id: "main", label: "W", type: "main", x: 50, y: 50 },
//         { id: "front", label: "Front", type: "sub", x: 25, y: 35 },
//         { id: "back", label: "Back", type: "sub", x: 75, y: 35 },
//         { id: "db", label: "DB", type: "sub", x: 50, y: 75 },
//         { id: "r", label: "R", type: "small", x: 35, y: 25 },
//         { id: "n", label: "N", type: "small", x: 65, y: 25 },
//         { id: "s", label: "S", type: "small", x: 50, y: 65 }
//       ]
//     },
//     {
//       id: 4,
...
//           type: "folder", 
//           children: [
//             { name: "사용자 프로필.json", type: "file" },
//             { name: "앱 설정.json", type: "file" },
//             { name: "테마 설정.css", type: "file" }
//           ] 
//         }
//       ],
//       chat: {
//         title: "설정 도움말",
//         content: "이 앱의 설정을 통해 다음과 같은 기능을 조정할 수 있습니다:\n\n1. 사용자 프로필: 이름, 이메일, 프로필 이미지 등의 개인 정보를 관리합니다.\n\n2. 앱 설정: 언어, 테마, 알림 설정 등 애플리케이션의 동작 방식을 조정합니다.\n\n3. 보안 설정: 비밀번호 변경, 이중 인증 설정, 세션 관리 등 보안 관련 설정을 관리합니다.\n\n설정을 변경한 후에는 저장 버튼을 클릭하여 변경 사항을 적용하세요. 기본 설정으로 복원하려면 '기본값으로 재설정' 옵션을 사용할 수 있습니다."
//       },
//       memo: {
//         title: "설정 메모",
//         content: "# 앱 설정 가이드\n\n## 테마 설정\n- 라이트 모드: 기본 테마\n- 다크 모드: 저조도 환경에 적합\n- 시스템 설정 따르기: 시스템 설정에 맞춤\n\n## 언어 설정\n- 한국어\n- English\n- 日本語\n\n## 설정 파일 예시\n```json\n{\n  \"theme\": \"light\",\n  \"language\": \"ko\",\n  \"notifications\": true,\n  \"autoSave\": {\n    \"enabled\": true,\n    \"interval\": 5\n  }\n}\n```\n\n설정 변경 후 앱 재시작이 필요할 수 있습니다."
//       },
//       nodes: [
//         { id: "main", label: "S", type: "main", x: 50, y: 50 },
//         { id: "user", label: "User", type: "sub", x: 30, y: 30 },
//         { id: "app", label: "App", type: "sub", x: 70, y: 30 },
//         { id: "theme", label: "Theme", type: "sub", x: 50, y: 70 },
//         { id: "p", label: "P", type: "small", x: 40, y: 40 },
//         { id: "t", label: "T", type: "small", x: 60, y: 60 }
//       ]
//     }
//   ];
