...
// // GraphViewForFullscreen.jsx - 노드 크기 커스터마이징 추가
...
//     // ✅ 옵시디언 스타일 설정 (0-100 범위)
//     const [graphSettings, setGraphSettings] = useState(() => {
//         const saved = localStorage.getItem('graphSettings_fullscreen');
//         return saved ? JSON.parse(saved) : {
//             nodeSize: 6,
//             linkWidth: 1,
//             textZoomThreshold: 0.5,
//             // ✅ 옵시디언 스타일 (0-100% 범위)
//             centerStrength: 50,    // 중심장력 (0-100%)
//             repelStrength: 50,     // 반발력 (0-100%)
//             linkStrength: 50,      // 링크장력 (0-100%)
//             linkDistance: 50,      // 링크거리 (0-100%)
//         };
//     });
...
//                 customLinkWidth={graphSettings.linkWidth}
//                 textDisplayZoomThreshold={graphSettings.textZoomThreshold}
//                 // ✅ 옵시디언 스타일 물리 props 전달 (0-100 범위)
//                 centerStrength={graphSettings.centerStrength}
//                 repelStrength={graphSettings.repelStrength}  // ✅ chargeStrength → repelStrength
//                 linkStrength={graphSettings.linkStrength}
//                 linkDistance={graphSettings.linkDistance}
//             />
...
//                             {/* ✅ 물리 설정 - 옵시디언 스타일 (0-100%) */}
//                             <div className="fullscreen-control-group">
//                                 <label>물리 설정</label>
//                                 <div className="fullscreen-slider-container">
//                                     {/* 중심장력 */}
//                                     <div className="fullscreen-slider-item">
//                                         <span className="fullscreen-slider-label">중심장력</span>
//                                         <input
//                                             type="range"
//                                             min="0"
//                                             max="100"
...
//                                             onChange={(e) => setGraphSettings(prev => ({
//                                                 ...prev,
//                                                 centerStrength: parseInt(e.target.value)
//                                             }))}
//                                             className="fullscreen-slider"
//                                         />
//                                         <span className="fullscreen-slider-value">{graphSettings.centerStrength}%</span>
//                                     </div>
...
//                                     {/* 링크 장력 */}
//                                     <div className="fullscreen-slider-item">
//                                         <span className="fullscreen-slider-label">링크장력</span>
//                                         <input
//                                             type="range"
//                                             min="0"
//                                             max="100"
...
//                                     {/* 링크 거리 */}
//                                     <div className="fullscreen-slider-item">
//                                         <span className="fullscreen-slider-label">링크거리</span>
//                                         <input
//                                             type="range"
//                                             min="0"
//                                             max="100"
